...
class FaceProcessor:
    @staticmethod
    def get_encoding(file, model: str = "large", number_of_times_to_upsample: int = 1) -> Union[list, None]:
        ...
        if len(face_locations) > 1:
            ...
            raise exceptions.WrongNumberOfFacesError("Number of faces on given image is more than 1")
